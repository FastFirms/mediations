...
@media(min-width:800px){.hero-inner{grid-template-columns:1fr 360px;gap:48px;padding:60px 48px 0;align-items:end}}
...
.hero-text h1{font-size:clamp(2rem,4.5vw,3.1rem);line-height:1.12;letter-spacing:-.02em;margin:0 0 18px;font-family:var(--serif);font-weight:700;color:var(--ink)}
...
@media(min-width:800px){.hero-art{display:flex;flex-direction:column;justify-content:flex-end;background:var(--sage-deep);border-radius:20px 20px 0 0;min-height:300px;position:relative;overflow:hidden;padding:28px}}
...
_HERO_ART = """<div class="hero-art" aria-hidden="true">
  ...
  <div class="hero-float">
    ...
    <div class="hero-float-text">
      ...
      <span>No obligation &middot; nationally accredited</span>
    </div>
  </div>
</div>"""
