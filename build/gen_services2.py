...
.access-strip p{color:rgba(255,255,255,.85);margin:0 0 6px;font-size:.93rem;line-height:1.55}
...
.access-strip-meta{font-size:.78rem;color:rgba(255,255,255,.6);margin-top:10px}
...
.dispute-grid{display:grid;grid-template-columns:repeat(auto-fit,minmax(200px,1fr));gap:14px;margin:20px 0 8px}
