...
LEGAL_UPDATES = [
    ...
    ("mediation-vs-collaborative-law", "Mediation vs Collaborative Law: Key Differences", "Compare mediation and collaborative law — costs, process, and legal outcomes — to choose the right path for your dispute."),
