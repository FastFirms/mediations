...
from templates import (head, nav, page_end, esc, crumb_html, faq_html, cta_band,
                       ...
                       img, BOOK_URL, PHONE, PHONE_HREF, DOMAIN, quiz_card)
...
doc += nav()
doc += f"""<main id="main">
<section class="phero" style="padding-bottom:clamp(48px,6vw,80px);background-image:linear-gradient(to right,rgba(247,250,247,1) 0%,rgba(247,250,247,.92) 38%,rgba(247,250,247,.55) 62%,rgba(247,250,247,.18) 100%),url('/assets/images/hero-mediation-session.jpg');background-size:cover;background-position:center 30%;position:relative">
