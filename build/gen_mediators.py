  ...
  <div class="wrap">
    <div class="mediator-profile">
      ...
      <aside class="mediator-photo">
        ...
        <div style="margin-top:28px;padding:20px;background:var(--sand);border-radius:12px;border:1px solid var(--line)">
          <p style="font-weight:700;font-size:.85rem;letter-spacing:.04em;text-transform:uppercase;color:var(--sage-deep);margin-bottom:12px">Disputes I Mediate</p>
          <ul style="list-style:none;padding:0;margin:0;font-size:.9rem;color:var(--ink-soft);line-height:2">
            <li><a href="/workplace-mediation/" style="color:inherit">Workplace Disputes</a></li>
            <li>Executive &amp; Leadership Conflict</li>
            <li><a href="/commercial-mediation/" style="color:inherit">Commercial Disputes</a></li>
            <li>Business &amp; Partnership Disputes</li>
            <li>Contractual Disputes</li>
            <li>Organisational Conflict</li>
          </ul>
        </div>
      </aside>
