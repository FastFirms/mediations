...
.ot-network{background:var(--sage-deep);color:var(--cream);padding:80px 0;background-image:url('/assets/images/MAbanner.png');background-size:cover;background-position:center}
