...
<section class="sec" id="dispute-types">
  <div class="wrap">
    ...
    <div class="cards reveal" style="margin-top:44px">
      ...
      <article class="card">
        <div class="ic"><svg width="24" height="24" viewBox="0 0 24 24" fill="none"><circle cx="11" cy="11" r="7" stroke="currentColor" stroke-width="1.6"/><path d="M21 21l-4.35-4.35M11 8v3M11 14h.01" stroke="currentColor" stroke-width="1.6" stroke-linecap="round"/></svg></div>
        <h3>Workplace Investigations &amp; Grievances</h3>
        <p>When a complaint needs handling well. When to investigate, when to mediate, and how to resolve grievances and repair a workplace without a drawn-out formal process.</p>
        <a class="more" href="/workplace-investigations-grievance-mediation/">Read the guide <span class="arr">→</span></a>
      </article>
    </div>
  </div>
</section>
  ...
  <div class="wrap">
    <div style="display:grid;grid-template-columns:220px 1fr;gap:60px;align-items:start;max-width:920px;margin:0 auto" class="mediator-pitch">
      ...
      <div>
        ...
        <p style="font-size:1.05rem;color:var(--ink);line-height:1.75;margin-bottom:16px">Dan brings a combination of experience that few workplace mediators can offer. He has run organisations, not merely advised them. As an award-winning lawyer, former CEO and Board Director, he understands the realities business owners face &mdash; staffing pressures, workplace culture, and governance &mdash; and appreciates what unresolved conflict genuinely costs an organisation in money, management time and the retention of good people.</p>
        <p style="font-size:1.05rem;color:var(--ink-soft);line-height:1.75;margin-bottom:16px">He also understands adjudication from the inside. As a former tribunal member who has sat as an independent decision-maker, he knows how unpredictable it can be to place a dispute in the hands of a third party to decide, and why parties are often better served by retaining control over the outcome themselves.</p>
        <p style="font-size:1.05rem;color:var(--ink-soft);line-height:1.75;margin-bottom:16px">His specialist training in team dynamics (Belbin) and Adaptive Leadership allows him to identify what is genuinely driving a conflict, beneath the positions each party puts forward. This insight is central to achieving resolutions that endure, rather than agreements that unravel over time.</p>
        <p style="font-size:1.05rem;color:var(--ink);line-height:1.75;margin-bottom:0">The result is an approach that treats a workplace dispute for what it usually is: not simply a legal problem, but an organisational and human one requiring a practical and durable resolution that both parties can accept and sustain.</p>
      </div>
    </div>
  </div>
</section>"""
